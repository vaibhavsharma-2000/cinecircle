...
import { X, Lock, Mail, UserCheck, LogIn, AlertCircle, Eye, EyeOff, CheckCircle2 } from "lucide-react";
...
export function AuthModal({ isOpen, onClose, onAuthSuccess }: AuthModalProps) {
  ...
  const handleOAuthGoogle = async () => {
    ...
    try {
      ...
      onAuthSuccess({
        email: "google.user@cinecircle.app",
        displayName: "Google Film Fan",
        username: "google_fan",
        avatarId: "tony_stark",
      });
      onClose();
  ...
  const handleSignInSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onAuthSuccess({
        email: userEmail,
        displayName: userMeta.display_name || userEmail.split("@")[0],
        username: userMeta.username || userEmail.split("@")[0],
        avatarId: userMeta.avatar_id || "tony_stark",
        age: userMeta.age,
      });
      onClose();
    } catch (err: unknown) {
